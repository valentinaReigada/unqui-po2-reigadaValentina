...
public class ServidorPop implements IServidor {
	/*
	 * Rompe con el principio 3, segregacion de interfaces, implementa una interfaz
	 * demaciado general para el uso que le va a dar ServidorPop.
	 * Al implementar Iservidor, debe implemmentar todos los metodos y este no usa a todos.
	 * 
	 * */
